...
int ImmutablePlayer::makeMove(int board[][3], int player) {
	switch (skill) {
		case 0:
			return rand()%9;
		case 1:
...
bool ImmutablePlayer::simulateBoard(int (**board)[3], int position, int playerId) {
...
void ImmutablePlayer::clearSimulation(int (**board)[3], int position) {
	//Todo: error checking
	(*board)[position/3][position%3] = 0;
}

int ImmutablePlayer::getConsecutiveHorizontal(int board[][3], int i, int j) {
...
int ImmutablePlayer::getConsecutiveVertical(int board[][3], int i, int j) {
	int consecutive = 1;
	int playerNum = board[i][j];
...
int ImmutablePlayer::getConsecutivePositiveDiagonal(int board[][3], int i, int j) {
	int consecutive = 1;
	int playerNum = board[i][j];
...
int ImmutablePlayer::getConsecutiveNegativeDiagonal(int board[][3], int i, int j) {
	int consecutive = 1;
	int playerNum = board[i][j];
...
int ImmutablePlayer::getScore(int board[][3], int player) {
...
int ImmutablePlayer::makeMove1(int board[][3], int player) {
...
int ImmutablePlayer::makeMove1random(int board[][3], int player) {
	int tempScore, column, bestScore = 0;
	int possibleMoves[9];
...
int ImmutablePlayer::makeMove2(int board[][3], int player) {
	int tempScore, column, bestScore = 0;
	//todo this
...
int ImmutablePlayer::makeMove2smart(int board[][3], int player) {
	int tempScore, column, bestScore = 0;
	//todo this
	int enemy_player = (player == 1) ? 2 : 1;
	int enemy_move;
...
int ImmutablePlayer::makeMoveN(int board[][3], int player, int n) {
	int MAX_MOVES = 5;
...
int ImmutablePlayer::makeMove2adaptive(int board[][3], int player) {
